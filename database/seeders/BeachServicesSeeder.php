    ...
    public function run(): void
    {
        ...
        $beachHuts = [
            [
                ...
                'booking_type' => 'fixed_slot',
                'slot_duration_minutes' => 180, // 3-hour slots
                'slot_price' => 500.00, // MVR 500 per 3 hours
                'price_per_hour' => null,
                'capacity_limit' => 1,
                'concurrent_capacity' => 1,
                'opening_time' => '08:00:00',
        ...
        // Insert all services
        DB::table('beach_services')->insert(array_merge($beachActivities, $waterSports, $beachHuts));
