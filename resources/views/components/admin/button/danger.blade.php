...
// Color classes (Red danger)
$colorClasses = 'bg-red-600 dark:bg-red-500 text-white hover:bg-red-700 dark:hover:bg-red-600 focus:ring-red-500';

// Disabled/Loading state classes
$stateClasses = '';
if ($disabled || $loading) {
    $stateClasses = 'opacity-50 cursor-not-allowed';
    $colorClasses = 'bg-red-600 dark:bg-red-500 text-white'; // Remove hover on disabled
}
