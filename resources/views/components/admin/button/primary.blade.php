...
// Color classes (Indigo primary)
$colorClasses = 'bg-indigo-600 dark:bg-indigo-500 text-white hover:bg-indigo-700 dark:hover:bg-indigo-600 focus:ring-indigo-500';

// Disabled/Loading state classes
$stateClasses = '';
if ($disabled || $loading) {
    $stateClasses = 'opacity-50 cursor-not-allowed';
    $colorClasses = 'bg-indigo-600 dark:bg-indigo-500 text-white'; // Remove hover on disabled
}
