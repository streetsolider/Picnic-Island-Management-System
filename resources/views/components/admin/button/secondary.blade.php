...
// Color classes (Gray secondary)
$colorClasses = 'bg-gray-600 dark:bg-gray-500 text-white hover:bg-gray-700 dark:hover:bg-gray-600 focus:ring-gray-500';

// Disabled/Loading state classes
$stateClasses = '';
if ($disabled || $loading) {
    $stateClasses = 'opacity-50 cursor-not-allowed';
    $colorClasses = 'bg-gray-600 dark:bg-gray-500 text-white'; // Remove hover on disabled
}
