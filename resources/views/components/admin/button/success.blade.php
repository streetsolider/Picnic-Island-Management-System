...
// Color classes (Green success)
$colorClasses = 'bg-green-600 dark:bg-green-500 text-white hover:bg-green-700 dark:hover:bg-green-600 focus:ring-green-500';

// Disabled/Loading state classes
$stateClasses = '';
if ($disabled || $loading) {
    $stateClasses = 'opacity-50 cursor-not-allowed';
    $colorClasses = 'bg-green-600 dark:bg-green-500 text-white'; // Remove hover on disabled
}
