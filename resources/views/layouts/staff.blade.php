...
<body class="font-sans antialiased">
    ...
    <x-admin.navigation.side-nav app-name="{{ $user->role->label() }}">
        <x-slot:logo>
            <a href="{{ route($dashboardRoute) }}" wire:navigate>
                <x-common.application-logo class="w-10 h-10 fill-current text-gray-500 dark:text-gray-400" />
            </a>
        </x-slot:logo>

        {{-- Navigation Links --}}
        <x-admin.navigation.nav-link :href="route($dashboardRoute)" :active="request()->routeIs($dashboardRoute)"
        ...
        @if($role === 'beach_staff')
            ...
            <x-admin.navigation.nav-link :href="route('beach.service-settings')" :active="request()->routeIs('beach.service-settings')"
            ...
            <x-admin.navigation.nav-link :href="route('beach.bookings')" :active="request()->routeIs('beach.bookings')"
                ...
                {{ __('Bookings Calendar') }}
            </x-admin.navigation.nav-link>

            <x-admin.navigation.nav-link :href="route('beach.validate')" :active="request()->routeIs('beach.validate')"
                icon='<svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>'>
                {{ __('Validate Bookings') }}
            </x-admin.navigation.nav-link>

            <x-admin.navigation.nav-link :href="route('beach.history')" :active="request()->routeIs('beach.history')"
        ...
        @if($role === 'theme_park_manager' || $role === 'theme_park_staff')
            @if($role === 'theme_park_manager')
            ...
            @if($role === 'theme_park_staff')
                ...
                <x-admin.navigation.nav-link :href="route('theme-park.ticket-history')" :active="request()->routeIs('theme-park.ticket-history')"
