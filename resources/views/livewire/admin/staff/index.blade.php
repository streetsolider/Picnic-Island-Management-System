                ...
                <form wire:submit="updateStaff">
                    ...
                    <div class="flex justify-between items-center gap-3 mt-6">
                        ...
                        <div class="flex gap-3">
                            <x-admin.button.warning wire:click="resetPassword({{ $this->staffId }})">
                                Reset Password
                            </x-admin.button.warning>
                            <x-admin.button.danger wire:click="openDeleteModal({{ $this->staffId }})">
                                Delete
        ...
        @if($showDeleteModal)
            ...
            <div class="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 min-w-[400px] max-w-[500px]" style="z-index: 100000;" @click.stop>
                ...
                <div class="flex justify-end gap-3">
                    ...
                    <x-admin.button.danger wire:click="deleteStaff">
                        Delete
                    </x-admin.button.danger>
                </div>
            </div>
