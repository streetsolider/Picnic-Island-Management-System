<div>
    ...
    @else
        <x-admin.accordion.wrapper :allowMultiple="true">
            @foreach ($categories as $category)
                <x-admin.accordion.item :id="'category-' . $category->id">
                            {{-- Custom Header --}}
                            <x-slot:header>
                            ...
                            <x-slot:actions>
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-indigo-100 dark:bg-indigo-900 text-indigo-800 dark:text-indigo-200">
                                    {{ $category->amenities->count() }} {{ Str::plural('item', $category->amenities->count()) }}
                                </span>
                                <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium {{ $category->is_active ? 'bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200' : 'bg-red-100 dark:bg-red-900 text-red-800 dark:text-red-200' }} ml-2">
                            ...
                            <div class="space-y-4">
                                {{-- Action Buttons --}}
                                <div class="flex items-center justify-end gap-3 pb-3 border-b border-gray-200 dark:border-gray-700">
                                            ...
                                            <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                                                <div class="flex-1">
                                                    ...
                                                    @if ($amenity->description)
                                                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1 ml-6">{{ $amenity->description }}</p>
                                                    @endif
                                                </div>
