<x-admin.card.base>
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div>
            ...
            <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">
                Default images for all {{ $selectedRoomType }} rooms
            </p>
        </div>
    ...
    @else
        <x-admin.card.empty-state
            title="No images for {{ $selectedRoomType }} rooms"
            description="Upload images to create a default gallery for all {{ $selectedRoomType }} room types."
