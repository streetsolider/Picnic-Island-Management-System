<div>
    ...
    @if($isManager)
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-2 lg:grid-cols-4">
            ...
            <x-admin.card.stat
                title="Ticket Price"
                :value="'MVR ' . number_format($ticketPrice, 2)"
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            ...
            <x-admin.card.base>
                <div class="text-center">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">Ticket Settings</h3>
                    <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">Configure global ticket pricing</p>
