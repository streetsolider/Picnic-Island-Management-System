<div>
    ...
    @else
            ...
            <div class="p-6">
                ...
                <form wire:submit.prevent="save" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="number" id="duration_minutes" wire:model="duration_minutes" min="5" step="5" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent" />
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">How long the show will last (auto-filled from activity, can be customized)</p>
        ...
        <div @confirm-delete.window="$dispatch('open-modal', 'delete-schedule')">
        ...
        <div @confirm-cancel.window="$dispatch('open-modal', 'cancel-schedule')">
            <x-admin.modal.confirmation
                name="cancel-schedule"
                title="Cancel Schedule?"
                description="Are you sure you want to cancel this schedule? Guests with bookings will be notified."
