<div>
    ...
    @elseif($selectedActivity)
        ...
        <x-admin.card.base class="mb-6">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div>
                    ...
                    <p class="text-lg font-semibold text-gray-900 dark:text-white">
                        {{ $selectedActivity->activity_type === 'continuous' ? 'Continuous Ride' : 'Scheduled Show' }}
                    </p>
                </div>
                <div>
            ...
            @if($selectedActivity->activity_type === 'continuous' && $selectedActivity->opening_time && $selectedActivity->closing_time)
            ...
            <x-admin.card.base>
                ...
                @if($ticket->status === 'redeemed')
                    <x-admin.alert.success class="mt-6">
                        This ticket has already been validated and the visitor can participate in the activity.
                    </x-admin.alert.success>
