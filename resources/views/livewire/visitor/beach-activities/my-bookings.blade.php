                ...
                <div class="mb-6">
                    ...
                    <div class="bg-blue-50 border border-blue-200 rounded-2xl p-4 mb-4">
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1">
                                <p class="text-sm font-semibold text-blue-900 mb-1">Refund Information</p>
                                <p class="text-sm text-blue-800">
                                    If you cancel this booking, your refund will be available from the <strong>Island Front Desk</strong>. Please present your booking reference when claiming your refund.
                                </p>
                            </div>
                        </div>
                    </div>
