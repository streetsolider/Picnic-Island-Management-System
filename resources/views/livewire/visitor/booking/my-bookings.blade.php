<div class="min-h-screen bg-gradient-to-br from-brand-light via-blue-50 to-brand-primary/10 py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-600">View and manage your hotel reservations</p>
        </div>
        ...
        @if ($bookings->isEmpty())
            <div class="bg-white rounded-3xl shadow-lg p-16 text-center">
                ...
                <h3 class="text-2xl font-display font-bold text-brand-dark mb-2">
                    No {{ $activeTab === 'upcoming' ? 'Upcoming' : ($activeTab === 'past' ? 'Past' : 'Cancelled') }} Bookings
                </h3>
                <p class="text-gray-600 mb-6">You don't have any {{ $activeTab }} bookings at the moment.</p>
